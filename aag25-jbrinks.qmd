...
subtitle: "Case Studies in Air Quality, Drought, and Climate Vulnerability"
transition: slide
lightbox: true
...
- Other materials examining California drought and Yellowknife wildfire disaster of 2023, demonstrating regional and local applications of open science tools

- Datasets integrated across these materials:
  - EPA ICIS-AIR & Toxic Release Inventory
  - CDC PLACES health outcomes & Social Vulnerability Index
  - NASA SEDAC population grids
  - NOAA drought monitor indices
...
<video data-autoplay loop muted>
  <source src="lesson_highlights.mp4" type="video/mp4">
</video>
:::
:::
